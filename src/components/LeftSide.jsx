...
export const LeftSide = ({ isCollapsed, toggleSidebar }) => {
    return (
        <div className="p-4 h-full flex flex-col">
            {/* Logo/Toggle Area */}
            <div
                className="flex items-center space-x-2 p-4 mb-8 cursor-pointer hover:bg-gray-900 rounded-lg"
            ...
            <nav className="space-y-2 flex-1">
                <NavLink
                    to="/dashboard"
                    className={({ isActive }) => `flex items-center space-x-3 p-3 rounded-lg transition-colors ${isActive ? 'bg-gray-800 text-white' : 'text-indigo-100 hover:bg-gray-800'}`}
                >
